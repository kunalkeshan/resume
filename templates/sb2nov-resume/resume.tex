...
%-----------EDUCATION-----------------
% Convention: Degree + Dates on row 1, School + GPA on row 2 (degree-first, matching references/Advith_Krishnan_Resume.pdf).
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Birla Institute of Technology and Science}{GPA: 3.66 (9.15/10.0).}
